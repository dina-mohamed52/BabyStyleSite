...
function CheckoutPage() {
  ...
  const showErrorsInAlert = (errorFields) => {
    ...
    if (errorFields.phone)
      errorList.push("⚠️ رقم الهاتف يجب أن يكون 11 رقم ويبدأ بـ 01");
    if (errorFields.phone2 === "رقم الهاتف الإضافي غير صحيح")
      errorList.push("⚠️ رقم الهاتف الإضافي غير صحيح");
    if (errorFields.city) errorList.push("⚠️ المحافظة مطلوبة");
    if (errorFields.address) errorList.push("⚠️ العنوان مطلوب");
    if (
      errorFields.phone2 === "رقم الهاتف الإضافي يجب أن يختلف عن الرقم الأساسي"
    )
  ...
  const getFieldClass = (fieldName) => {
    const baseClass =
      "w-full bg-white/50 backdrop-blur-sm border-2 rounded-xl py-3.5 px-4 text-gray-700 text-sm outline-none transition-all duration-300 placeholder:text-gray-400";
    if (errors[fieldName])
  ...
  if (orderPlaced) {
    return (
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="min-h-screen bg-gradient-to-br from-[#F5A0CA]/20 via-white to-[#F472B6]/10 flex items-center justify-center px-4"
      >
        <div className="text-center">
          <motion.div
            ...
            className="w-24 h-24 mx-auto bg-gradient-to-r from-[#F472B6] to-[#F5A0CA] rounded-2xl flex items-center justify-center mb-6 shadow-2xl"
          >
          ...
          <motion.h2
            ...
            className="text-2xl font-bold text-[#1C2533] mb-2"
          >
            تم استلام طلبك! 🎉
          </motion.h2>
          <motion.p
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#F5A0CA]/20 via-white to-[#F472B6]/10 flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-[#1C2533] mb-2">
            سلة التسوق فارغة
          </h2>
          <p className="text-gray-400 mb-6">
            أضف بعض المنتجات الجميلة إلى سلة التسوق
          </p>
          <button
            onClick={() => navigate("/")}
            className="px-8 py-3 bg-gradient-to-r from-[#F472B6] to-[#F5A0CA] text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all"
          >
            ابدأ التسوق الآن
          </button>
        </div>
  ...
  return (
    <div
      dir="rtl"
      className="min-h-screen bg-gradient-to-br from-[#F5A0CA]/10 via-white to-[#F472B6]/5"
    >
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <motion.button
              whileHover={{ x: -5 }}
              onClick={() => navigate(-1)}
              className="flex items-center gap-2 text-gray-500 hover:text-[#F472B6] transition-colors"
            >
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-bold text-[#1C2533]">إتمام الطلب</h1>
            </div>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-2 mt-3">
                          ...
                          <div className="flex items-center gap-1.5 text-xs bg-gradient-to-r from-[#F5A0CA]/20 to-[#F472B6]/10 px-3 py-1.5 rounded-xl">
                            ...
                            <span className="text-[#1C2533] font-medium">
                          ...
                          <div className="mt-4 pt-3 border-t border-dashed border-[#F5A0CA]/20">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {item.offerDetails.pieces.map((piece, pIdx) => (
                                <div
                                  key={pIdx}
                                  className="flex flex-col gap-0.5 bg-gray-50 px-3 py-1.5 rounded-xl text-xs border border-gray-100 shadow-sm min-w-[120px]"
                                >
                                  {/* اسم القطعة */}
                                  ...
                                  <div className="flex flex-col gap-0.5 mt-0.5">
                                    ...
                                    {piece.quantity > 1 && (
                                      <span className="text-[#F472B6] font-medium text-[10px]">
                                        ×{piece.quantity}
                                      </span>
                                    )}
                                  </div>
              ...
              <form onSubmit={handleSubmit} className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="md:col-span-2" ref={fullNameRef}>
                    <label className="block text-sm font-semibold text-[#1C2533] mb-2">
                      الاسم الكامل *
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows="2"
                      className="w-full bg-white/50 backdrop-blur-sm border-2 border-[#F5A0CA] rounded-xl py-3 px-4 text-gray-700 text-sm focus:border-[#F472B6] focus:outline-none transition-all"
                ...
                >
                  {loading ? (
                    ...
                    <>
                      <CreditCard className="w-5 h-5" /> تأكيد الطلب - {total}{" "}
                      ج.م
                    </>
                  )}
                </motion.button>
                ...
                <div className="p-6 space-y-5">
                  ...
                  <div className="space-y-2 max-h-48 overflow-y-auto">
                    {cartItems.map((item, idx) => (
                      <div
                        key={idx}
                        className="flex justify-between items-center text-sm py-2 border-b border-[#F5A0CA]/20"
                      >
                        <div className="flex items-center gap-2">
                        ...
                        <span className="font-semibold text-[#1C2533]">
                          {item.price * item.quantity} ج.م
                        </span>
                      </div>
                    ))}
                  ...
                  <div className="space-y-3 pt-3 border-t border-[#F5A0CA]/20">
                    ...
                    <div className="border-t-2 border-dashed border-[#F5A0CA]/30 pt-3 mt-2">
                      <div className="flex justify-between items-center">
                        <span className="font-bold text-[#1C2533] text-lg">
                          الإجمالي
                        </span>
